  ...
  GymRole.admin: RolePalette(
    ...
    gradient: const LinearGradient(
      colors: [
        Color(0xFF7A5AE0),
        Color(0xFFFFB300),
      ], // Electric Violet and Amber highlights
      begin: Alignment.topLeft,
      end: Alignment.bottomRight,
    ),
...
final List<CashierAccount> cashiers = <CashierAccount>[
  ...
  CashierAccount(
    name: 'Luis Yupanqui',
    shift: '14:00 - 22:00',
    permissions: <String>['Cobros', 'Asistencia', 'Ventas', 'Productos'],
    active: true,
  ),
  CashierAccount(
    name: 'Valeria Ruiz',
    shift: '18:00 - 22:00',
    permissions: <String>['Cobros', 'Usuarios', 'Log lectura'],
    active: false,
  ),
];
...
final List<AuditEntry> cashierLogs = <AuditEntry>[
  ...
  AuditEntry(
    time: '10:22',
    action: 'Cobró membresía',
    detail: 'Jorge Paredes · S/ 1.080 · Tarjeta',
    actor: 'Mariana Q.',
    color: Color(0xFF00B85C),
  ),
  AuditEntry(
    time: '09:48',
    action: 'Vendió producto',
    detail: 'Polo oficial L · S/ 45 · Yape',
    actor: 'Mariana Q.',
  ...
  AuditEntry(
    ...
    detail: 'Ana Torres · actualizó celular',
    actor: 'Mariana Q.',
    color: Color(0xFFFFB300),
  ),
  AuditEntry(
    time: '08:42',
    action: 'Registró ingreso',
    detail: 'Mateo Salas · QR escaneado',
    actor: 'Mariana Q.',
