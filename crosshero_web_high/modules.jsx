    ...
    <div className="content-wrap">
      <div className="grid cols-2">
        <Panel title="Datos del gimnasio">
          <div className="field"><label>Nombre comercial</label><input defaultValue="FitZone Gym"/></div>
          <div className="row-2">
            <div className="field"><label>Años de funcionamiento</label><input defaultValue="5"/></div>
            <div className="field"><label>Teléfono / WhatsApp</label><input defaultValue="951 234 567"/></div>
          </div>
          <div className="field"><label>Dirección</label><input defaultValue="Av. Ejército 1234, Miraflores"/></div>
          <div className="field"><label>Horario de atención</label><input defaultValue="L–V 5am–11pm · S/D 7am–9pm"/></div>
        </Panel>

        <div className="grid" style={{ gap: 16, alignContent: "start" }}>
          <Panel title="Reglas operativas">
            <div className="row-2">
              <div className="field"><label>Día de gracia</label><input defaultValue="1"/></div>
              <div className="field"><label>Aviso pre-vencimiento</label><input defaultValue="7 días"/></div>
            </div>
          ...
          <Panel title="Identidad">
            <div style={{ display: "flex", gap: 14, alignItems: "center" }}>
              <span style={{ width: 64, height: 64, borderRadius: 14, background: "var(--ink)", color: "var(--accent)", display: "grid", placeItems: "center", font: "800 24px var(--font-display)" }}>F</span>
              <Btn kind="ghost">Cambiar logo</Btn>
            </div>
          </Panel>
        </div>
      </div>
      <div style={{ display: "flex", justifyContent: "flex-end", marginTop: 16 }}>
        <Btn kind="primary" leading={I.check}>Guardar cambios</Btn>
      </div>
    </div>
  );
}
