...
## 11. Mockups Detallados â€” Vistas por Plataforma y Rol

### 11.0 Roles y Accesos (mapeo rÃ¡pido)

Este mapeo resume quÃ© rol usa cada mockup y quÃ© permisos/acciones clave aparecen en las vistas. Se mantiene coherencia con la planificaciÃ³n tÃ©cnica y el documento de Design Thinking (secciÃ³n `1.4 Roles del Sistema`).
...
| **Administrador** | Web Admin + App Admin (Flutter) | Gestionar usuarios, membresÃ­as, horarios, ver dashboard local (WEB-01, WEB-02, WEB-03, MOB-ADMIN-01) |
| **Caja / RecepciÃ³n** | App Flutter (Caja) | Escanear QR, validar acceso, registrar pagos en efectivo (MOB-ADMIN-02, MOB-ADMIN-03) |
| **Entrenador** | App Entrenador (Flutter) | Ver lista de alumnos, vista tÃ©cnica, asignar/editar rutinas (MOB-TRAINER-01, MOB-TRAINER-02, MOB-TRAINER-03) |
| **Usuario / Practicante** | App Usuario (Flutter) | Mostrar QR, iniciar asistente de entrenamiento, pagar membresÃ­a (ExerciseCard, QR Member Screen, Mi Agenda) |

Notas:
- En cada mockup donde se muestra informaciÃ³n sensible (pagos, DNI, datos fÃ­sicos), la vista debe respetar el principio de mÃ­nima exposiciÃ³n por rol.
- Las acciones rÃ¡pidas en las vistas mÃ³viles (escaneo, registrar pago, marcar serie completada) deben diseÃ±arse para un flujo en < 2 segundos cuando sea crÃ­tico.


### 11.1 Panel Admin Web (Escritorio â€” responsive)

> Panel de administraciÃ³n accesible desde navegador. DiseÃ±o sidebar izquierdo + contenido principal.
